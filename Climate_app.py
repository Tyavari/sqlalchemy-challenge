...
def precipitation():
    ...
    # Convert from a list to a dictionary 
    all_prcp = []
...
def Start_date(start_date):
    ...
    """Return min, avg and max TOBS for a start date"""
    # Query all TOBS
...
def Start_end_date(start_date, end_date):
    ...
    # Append row data to a list of start_end_date_tobs and Create a dictionary
    start_end_tobs = []
    for min, avg, max in results:
        start_end_tobs_dict = {}
